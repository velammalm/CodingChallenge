...
public class TC005_DeleteProductFromCartPage extends TestBase {
	...
	public void setValues() {
		testCaseName = "Delete Product from Cart Page";
		testDescription = "Validation of removing product selection in cart page";
		authors = "lampenwelt";
		category = "Regression";
		dataSheetName = "TestData_TC005";
	}
	...
	public void validateProductSearch(String product_1, String product_2, String product_3)
		...
		try {
			...
			for (int i = 0; i < products.size(); i++) {
				...
				test.log(Status.PASS, "Products added to cart successfu+lly");
			}
			...
			.deleteProduct();
			double cost=shoppingCartPage.deletedItemCost;
			shoppingCartPage.verifysubTotalCost(Precision.round(addedCost-cost, 2))
			.calculateGrandTotal().verifyTotalGrandCost(shoppingCartPage.grandTotal);
		} catch (Exception e) {
