...
public class TC003_UpdateShippingCountry extends TestBase {
	...
	public void setValues() {
		testCaseName = "Update Shipping Country";
		testDescription = "Validation of shipping cost when country is updated in cart page";
		authors = "lampenwelt";
		category = "Regression";
	...
	public void validateProductSearch(String product_1, String product_2, String product_3, String country)
